  ...
  return (
    <div className='flex-1 flex flex-col justify-center items-center bg-[#031321]'>
        <div className='flex flex-col scale-75 md:scale-100'>
            {/* Blue */}
            <div className="flex relative m-3 border-solid border-2 border-[#255784]
                ...
                <div className="relative px-4 py-4 uppercase text-[#255784] text-xl tracking-wider
                              hover:bg-black hover:outline hover:outline-2 hover:outline-[#255784]">
                        Neon Button
                </div>
            </div>
            {/* Green */}
            <div className="flex relative m-3 border-solid border-2 border-[#055205]
                ...
                <div className="relative px-4 py-4 uppercase text-[#0c8612] text-xl tracking-wider
                              hover:bg-black hover:outline hover:outline-2 hover:outline-[#055205]">
                        Neon Button
                </div>
            </div>
            {/* Red */}
            <div className=" flex relative m-3 border-solid border-2 border-[#8a1616]
                ...
                <div className="relative px-4 py-4 uppercase text-[#c51313] text-xl tracking-wider
                              hover:bg-black hover:outline hover:outline-2 hover:outline-[#c51313]">
                        Neon Button
                </div>
            </div>
            {/* Black */}
            <div className="flex items-center relative m-3 border-solid border-2 border-black
                ...
                <div className="relative px-4 py-4 uppercase text-[#585353] text-xl tracking-wider
                              hover:bg-black hover:outline hover:outline-2 hover:outline-[#585353]">
                        Neon Button
                </div>
            </div>
            {/* Multicolor */}
            <div className="flex items-center relative m-3   p-px bg-gradient-to-r from-[#743ad5] to-red-700">
              ...
              <div className="bg-[#031321] flex">
                <div className="text-[#743ad5] p-5">
